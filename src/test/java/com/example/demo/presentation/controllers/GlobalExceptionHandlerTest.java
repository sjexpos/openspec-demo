    ...
    void handleValidation_shouldReturn400() throws Exception {
        ...
        mockMvc.perform(post("/test/validations")
                ...
                .andExpect(jsonPath("$.errors[*]", containsInAnyOrder(
                        ...
                        allOf(hasEntry("field", "email"), hasEntry("message", "email must not be empty")),
                        allOf(hasEntry("field", "enumeration"), hasEntry("message", "enumeration must not be empty")))));
    }
